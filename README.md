...
A full stack Google Boooks API search engine application using the Mern stack - a React front end, MongoDB datatbase, and Node.js/Express.js sever and API.
## User Story
...
```
## Installation
And NPM install needs to be run on both the client and server directories.
